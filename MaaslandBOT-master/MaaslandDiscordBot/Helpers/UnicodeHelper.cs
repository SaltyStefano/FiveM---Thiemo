namespace MaaslandDiscordBot.Helpers
{
    ...
    {
        public static Dictionary<string, string>  UnicodeEmojis = new Dictionary<string, string>
            {
                [",:("] = "\U0001f613",
                [",:)"] = "\U0001f605",
                [",:-("] = "\U0001f613",
        ...
        {
            if (UnicodeEmojis.ContainsKey(code))
            {
                return UnicodeEmojis[code];
            }

            return UnicodeEmojis[":warning:"];
        }
    }
}
